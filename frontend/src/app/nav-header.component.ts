    ...
    <div class="flex items-center gap-4 px-6 py-3 bg-gray-800 border-b border-gray-700">
      ...
      <div class="flex items-center gap-1 ml-4">
        ...
        <a
          ...
          [class]="navCls(homeLink.isActive)"
          title="Home"
        >
          <svg
        ...
        <!-- Chat --- OLD delete me when everything has been harvested. -->
        <!-- <a routerLink="/chat" routerLinkActive #chatLink="routerLinkActive"
           [class]="navCls(chatLink.isActive)"
           title="Chat">
